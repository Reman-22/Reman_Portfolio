...
const Education = ({sectionRef,ContactRef}) => {
  ...
  return (
    <div className='Edc' ref={sectionRef}>
        ...
        <Title   title="Education " description=" ادرس في السنة الأخيرة من كلية الهندسة المعلوماتية تخصص الذكاء الاصطناعي تعلم الآلة. مكنتني هذه الدراسة من امتلاك خلفية برمجية قوية تتجاوز بناء الواجهات التقليدية، حيث أسعى لدمج الخوارزميات الذكية والحلول الهندسية المبتكرة في تطوير الويب لخلق مواقع أكثر ذكاءً واستجابة لاحتياجات المستخدمين"/>
        </div>
        <div className='offer'>
